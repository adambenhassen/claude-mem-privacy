"use strict";var ps=Object.create;var V=Object.defineProperty;var ms=Object.getOwnPropertyDescriptor;var gs=Object.getOwnPropertyNames;var Ts=Object.getPrototypeOf,fs=Object.prototype.hasOwnProperty;var Ss=(r,e)=>{for(var t in e)V(r,t,{get:e[t],enumerable:!0})},Me=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of gs(e))!fs.call(r,n)&&n!==t&&V(r,n,{get:()=>e[n],enumerable:!(s=ms(e,n))||s.enumerable});return r};var D=(r,e,t)=>(t=r!=null?ps(Ts(r)):{},Me(e||!r||!r.__esModule?V(t,"default",{value:r,enumerable:!0}):t,r)),As=r=>Me(V({},"__esModule",{value:!0}),r);var Er={};Ss(Er,{generateContext:()=>us,generateContextWithStats:()=>De});module.exports=As(Er);var ls=D(require("path"),1),cs=require("os"),Es=require("fs");var Oe=require("bun:sqlite");var g=require("path"),fe=require("os"),x=require("fs");var Ze=require("url");var N=require("fs"),ze=require("path");var Rs=null;function bs(r){return(Rs??process.stderr.write.bind(process.stderr))(r)}function _e(r){bs(r)}var Os=["SECRETS","EMAIL","OPERATOR","PHONE","POSTAL","NATIONAL_ID","FINANCIAL","GEO","CUSTOM"];function ye(r){return Os.includes(r)}var hs=/^(?:your[_-]?\w*|changeme|your-key-here|example\w*|x{3,}|<[^>]*>|\$\{?\w+\}?|\[redacted:\w+\])$/i,Cs=/^[A-Z][A-Z0-9_]{2,}$/;function ve(r){let e=r.trim();return hs.test(e)||Cs.test(e)}function Ue(r){let e=r.replace(/\D/g,"");if(e.length>15)return r;let t=r.trimStart().startsWith("+");return t&&e.length>=8||!t&&e.length>=10?"[REDACTED:PHONE]":r}function Is(r){let e=r.replace(/\s/g,"").toUpperCase();if(!/^[A-Z]{2}\d{2}[A-Z0-9]{10,30}$/.test(e))return!1;let t=e.slice(4)+e.slice(0,4),s=0;for(let n of t){let o=n>="A"&&n<="Z"?String(n.charCodeAt(0)-55):n;for(let i of o)s=(s*10+(i.charCodeAt(0)-48))%97}return s===1}function Ns(r){if(!r)return 0;let e={};for(let s of r)e[s]=(e[s]??0)+1;let t=0;for(let s of Object.values(e)){let n=s/r.length;t-=n*Math.log2(n)}return t}function Ls(r){return r.length<20||/^REDACTED/.test(r)||!(/[a-z]/.test(r)&&/[A-Z]/.test(r)&&/[0-9]/.test(r))||ve(r)?!1:Ns(r)>=3}function Ds(r){let e=r.replace(/[ -]/g,"");if(!/^\d{13,19}$/.test(e))return!1;let t=0,s=!1;for(let n=e.length-1;n>=0;n--){let o=e.charCodeAt(n)-48;s&&(o*=2,o>9&&(o-=9)),t+=o,s=!s}return t%10===0}var le=/\b[A-Za-z0-9._%+-]{1,64}@[A-Za-z0-9.-]{1,255}\.[A-Za-z]{2,24}\b/g,xe=/(?<![\w.])(?:\+\d{1,3}[\s.-]?)?(?:\(\d{1,4}\)[\s.-]?)?\d{2,4}(?:[\s.-]\d{2,4}){1,3}(?![\w])/g,Pe=/\b\d{1,5}\s+(?:[A-Z][a-zA-Z]+\s){1,3}(?:Street|St|Avenue|Ave|Boulevard|Blvd|Road|Rd|Lane|Ln|Drive|Dr|Court|Ct|Way|Square|Sq|Terrace|Ter)\b\.?/g,we=[{category:"SECRETS",label:"PRIVATE_KEY",regex:/-----BEGIN (?:[A-Z0-9 ]+ )?PRIVATE KEY-----[\s\S]{0,100000}?-----END (?:[A-Z0-9 ]+ )?PRIVATE KEY-----/g},{category:"SECRETS",label:"PRIVATE_KEY",regex:/-----BEGIN (?:[A-Z0-9 ]+ )?PRIVATE KEY-----/g},{category:"SECRETS",label:"SSH_KEY",regex:/\b(?:ssh-(?:rsa|ed25519|dss)|ecdsa-sha2-nistp(?:256|384|521)|sk-(?:ssh-ed25519|ecdsa-sha2-nistp256)@openssh\.com)\s+AAAA[A-Za-z0-9+/=]{20,}/g},{category:"SECRETS",label:"JWT",regex:/\beyJ[A-Za-z0-9_-]{3,4096}\.eyJ[A-Za-z0-9_-]{3,4096}\.[A-Za-z0-9_-]{3,4096}/g},{category:"SECRETS",label:"B64_JSON",regex:/\beyJ[A-Za-z0-9+/=_-]{20,}/g},{category:"SECRETS",label:"B64_PEM",regex:/\bLS0tLS1CRUdJTi[A-Za-z0-9+/=]{40,}/g},{category:"SECRETS",label:"B64_JWT",regex:/\bZXlK[A-Za-z0-9+/=]{40,}/g},{category:"SECRETS",label:"ANTHROPIC_KEY",regex:/\bsk-ant-[A-Za-z0-9_-]{8,}/g},{category:"SECRETS",label:"OPENROUTER_KEY",regex:/\bsk-or-v1-[A-Za-z0-9]{8,}/g},{category:"SECRETS",label:"LANGFUSE_KEY",regex:/\bsk-lf-[A-Za-z0-9-]{8,}/g},{category:"SECRETS",label:"OPENAI_PROJECT_KEY",regex:/\bsk-proj-[A-Za-z0-9_-]{8,}/g},{category:"SECRETS",label:"CONTEXT7_KEY",regex:/\bctx7sk-[A-Za-z0-9]{8,}/g},{category:"SECRETS",label:"GITHUB_PAT",regex:/\b(?:gh[opusr]_[A-Za-z0-9]{20,}|github_pat_[A-Za-z0-9_]{20,})/g},{category:"SECRETS",label:"GITLAB_PAT",regex:/\bglpat-[A-Za-z0-9_-]{20,}/g},{category:"SECRETS",label:"AWS_ACCESS_KEY",regex:/\b(?:AKIA|ASIA)[0-9A-Z]{16}\b/g},{category:"SECRETS",label:"GOOGLE_API_KEY",regex:/\bAIza[0-9A-Za-z_-]{35}\b/g},{category:"SECRETS",label:"SLACK_TOKEN",regex:/\bxox[baprs]-[A-Za-z0-9-]{8,}/g},{category:"SECRETS",label:"STRIPE_KEY",regex:/\b(?:sk|rk|pk)_(?:live|test)_[A-Za-z0-9]{8,}/g},{category:"SECRETS",label:"SENDGRID_KEY",regex:/\bSG\.[A-Za-z0-9_-]{16,}\.[A-Za-z0-9_-]{16,}/g},{category:"SECRETS",label:"GROQ_KEY",regex:/\bgsk_[A-Za-z0-9]{16,}/g},{category:"SECRETS",label:"TURNSTILE_KEY",regex:/\b0x4AAA[A-Za-z0-9_-]{8,}/g},{category:"SECRETS",label:"HUGGINGFACE_TOKEN",regex:/\bhf_[A-Za-z0-9]{16,}/g},{category:"SECRETS",label:"REPLICATE_TOKEN",regex:/\br8_[A-Za-z0-9]{16,}/g},{category:"SECRETS",label:"DIGITALOCEAN_TOKEN",regex:/\bdop_v1_[A-Za-z0-9]{32,}/g},{category:"SECRETS",label:"NPM_TOKEN",regex:/\bnpm_[A-Za-z0-9]{36}\b/g},{category:"SECRETS",label:"PYPI_TOKEN",regex:/\bpypi-[A-Za-z0-9_-]{16,}/g},{category:"SECRETS",label:"SHOPIFY_TOKEN",regex:/\b(?:shpat|shppa)_[A-Fa-f0-9]{32}\b/g},{category:"SECRETS",label:"GENERIC_API_KEY",regex:/\bsk-[A-Za-z0-9]{20,}\b/g},{category:"SECRETS",label:"BEARER_TOKEN",regex:/\bBearer\s+[A-Za-z0-9._-]{8,}/g},{category:"SECRETS",label:"BASIC_AUTH",regex:/\b([a-z][a-z0-9+.-]*:\/\/)[^/\s:@]+:[^/\s@]+@/gi,replace:(r,e)=>`${e}[REDACTED:BASIC_AUTH]@`},{category:"SECRETS",label:"SECRET",regex:/\b(\w{0,32}(?:password|passwd|secret|token|api[_-]?key|access[_-]?key|encryption[_-]?key|signing[_-]?key|[_-]key))(\s*[:=]\s*)(?:"([^"]{1,200})"|'([^']{1,200})'|([^\s"']{8,200}))/gi,replace:(r,e,t,s,n,o)=>{let i=s??n??o??"",a=s!==void 0||n!==void 0;return ve(i)||!a&&i.length<8?r:`${e}${t}[REDACTED:SECRET]`}},{category:"FINANCIAL",label:"CREDIT_CARD",regex:/\b(?:\d[ -]?){13,19}\b/g,replace:r=>{let e=r.replace(/[ -]/g,"");return/^(\d)\1+$/.test(e)?r:Ds(e)?"[REDACTED:CREDIT_CARD]":r}},{category:"FINANCIAL",label:"IBAN",regex:/\b[A-Z]{2}\d{2}[A-Z0-9]{10,30}\b/g,replace:r=>Is(r)?"[REDACTED:IBAN]":r},{category:"FINANCIAL",label:"ETH_ADDRESS",regex:/\b0x[0-9a-fA-F]{40}\b/g},{category:"FINANCIAL",label:"BTC_ADDRESS",regex:/\b(?:bc1[ac-hj-np-z02-9]{11,87}|[13][a-km-zA-HJ-NP-Z1-9]{25,34})\b/g},{category:"NATIONAL_ID",label:"US_SSN",regex:/\b(?!000|666|9\d\d)\d{3}-(?!00)\d{2}-(?!0000)\d{4}\b/g},{category:"NATIONAL_ID",label:"US_EIN",regex:/\b\d{2}-\d{7}\b/g},{category:"NATIONAL_ID",label:"EU_VAT",regex:/\b(?:AT|BE|BG|CY|CZ|DE|DK|EE|EL|ES|FI|FR|HR|HU|IE|IT|LT|LU|LV|MT|NL|PL|PT|RO|SE|SI|SK)\d[0-9A-Z]{7,11}\b/g},{category:"NATIONAL_ID",label:"UA_TAX_ID",regex:/(?:ІПН|ИНН|РНОКПП|tax(?:payer)?\s*(?:id|number))\D{0,10}\d{10}\b/gi,replace:r=>r.replace(/\d{10}\b/,"[REDACTED:UA_TAX_ID]")},{category:"GEO",label:"GEO_COORD",regex:/\b[-+]?(?:90(?:\.0+)?|[0-8]?\d\.\d{3,}),\s*[-+]?(?:180(?:\.0+)?|1[0-7]\d\.\d{3,}|\d?\d\.\d{3,})\b/g},{category:"SECRETS",label:"HIGH_ENTROPY",regex:/[A-Za-z0-9_-]{20,}/g,replace:r=>Ls(r)?"[REDACTED:HIGH_ENTROPY]":r}];var Fe=require("node:child_process");var q=null,ke=!1;function ce(r,e){try{let t=(0,Fe.execFileSync)("git",r,{cwd:e,encoding:"utf8",stdio:["ignore","pipe","ignore"]});return typeof t=="string"?t.trim():""}catch(t){let s=t;return s.code&&s.status==null&&!ke&&(ke=!0,l.warn("REDACT","git unavailable; operator self-redaction is disabled (cannot derive identity)",{code:s.code})),""}}function Ms(r=process.cwd()){if(q)return q;let e=new Set,t=new Set,s=new Set,n=(o,i)=>{if(o&&e.add(o),i){t.add(i);let a=i.split("@")[0]??"";a.length>=3&&(/[._\-0-9]/.test(a)||a.length>=6)&&s.add(a)}};return n(ce(["config","--global","user.name"]),ce(["config","--global","user.email"])),n("",ce(["config","user.email"],r)),q={names:[...e],emails:[...t],handles:[...s]},q}var Ee=r=>r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");function $e(r=Ms()){let e=[];for(let t of r.emails)e.push({category:"OPERATOR",label:"OPERATOR_EMAIL",regex:new RegExp(Ee(t),"gi")});for(let t of r.names)e.push({category:"OPERATOR",label:"OPERATOR_NAME",regex:new RegExp(`\\b${Ee(t)}\\b`,"gi")});for(let t of r.handles)e.push({category:"OPERATOR",label:"OPERATOR_HANDLE",regex:new RegExp(`\\b${Ee(t)}\\b`,"gi")});return e}var We=D(require("os"),1),J=D(require("path"),1),Ke=require("fs");var I=require("fs"),$=require("path"),pe=require("os");var ue={DEFAULT:3e5,HEALTH_CHECK:3e3,API_REQUEST:3e4,HOOK_READINESS_WAIT:1e4,POST_SPAWN_WAIT:15e3,READINESS_WAIT:3e4,PORT_IN_USE_WAIT:3e3,WORKER_STARTUP_WAIT:1e3,PRE_RESTART_SETTLE_DELAY:2e3,POWERSHELL_COMMAND:1e4,WINDOWS_MULTIPLIER:1.5};function He(r){return process.platform==="win32"?Math.round(r*ue.WINDOWS_MULTIPLIER):r}var v=class{static DEFAULTS={CLAUDE_MEM_MODEL:"claude-haiku-4-5-20251001",CLAUDE_MEM_EFFORT_LEVEL:"",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_API_TIMEOUT_MS:String(He(ue.API_REQUEST)),CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_SKIP_COMMANDS:"",CLAUDE_MEM_SKIP_PATHS:"",CLAUDE_MEM_PROVIDER:"claude",CLAUDE_MEM_CLAUDE_AUTH_METHOD:"subscription",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_GEMINI_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_GEMINI_MAX_TOKENS:"100000",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_BASE_URL:"",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:"claude-mem",CLAUDE_MEM_OPENROUTER_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_OPENROUTER_MAX_TOKENS:"100000",CLAUDE_MEM_CUSTOM_API_KEY:"",CLAUDE_MEM_CUSTOM_MODEL:"",CLAUDE_MEM_CUSTOM_BASE_URL:"",CLAUDE_MEM_PROVIDER_PROJECT_OVERRIDES:"{}",CLAUDE_MEM_DATA_DIR:(0,$.join)((0,pe.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"false",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"false",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_FULL_COUNT:"0",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",CLAUDE_MEM_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",CLAUDE_MEM_WELCOME_HINT_ENABLED:"true",CLAUDE_MEM_FOLDER_CLAUDEMD_ENABLED:"false",CLAUDE_MEM_FOLDER_USE_LOCAL_MD:"false",CLAUDE_MEM_TRANSCRIPTS_ENABLED:"true",CLAUDE_MEM_TRANSCRIPTS_CONFIG_PATH:(0,$.join)((0,pe.homedir)(),".claude-mem","transcript-watch.json"),CLAUDE_MEM_CODEX_TRANSCRIPT_INGESTION:"false",CLAUDE_MEM_MAX_CONCURRENT_AGENTS:"2",CLAUDE_MEM_HOOK_FAIL_LOUD_THRESHOLD:"3",CLAUDE_MEM_ALLOWED_PROJECTS:"",CLAUDE_MEM_EXCLUDED_PROJECTS:"",CLAUDE_MEM_FOLDER_MD_EXCLUDE:"[]",CLAUDE_MEM_FOLDER_MD_SKELETON_DENYLIST:"[]",CLAUDE_MEM_SEMANTIC_INJECT:"false",CLAUDE_MEM_SEMANTIC_INJECT_LIMIT:"5",CLAUDE_MEM_TIER_ROUTING_ENABLED:"true",CLAUDE_MEM_TIER_SIMPLE_MODEL:"haiku",CLAUDE_MEM_TIER_SUMMARY_MODEL:"",CLAUDE_MEM_TIER_FAST_MODEL:"haiku",CLAUDE_MEM_TIER_SMART_MODEL:"sonnet",CLAUDE_MEM_CHROMA_ENABLED:"true",CLAUDE_MEM_CHROMA_MODE:"local",CLAUDE_MEM_CHROMA_HOST:"127.0.0.1",CLAUDE_MEM_CHROMA_PORT:"8000",CLAUDE_MEM_CHROMA_SSL:"false",CLAUDE_MEM_CHROMA_API_KEY:"",CLAUDE_MEM_CHROMA_TENANT:"default_tenant",CLAUDE_MEM_CHROMA_DATABASE:"default_database",CLAUDE_MEM_TELEGRAM_ENABLED:"true",CLAUDE_MEM_TELEGRAM_BOT_TOKEN:"",CLAUDE_MEM_TELEGRAM_CHAT_ID:"",CLAUDE_MEM_TELEGRAM_TRIGGER_TYPES:"security_alert",CLAUDE_MEM_TELEGRAM_TRIGGER_CONCEPTS:"",CLAUDE_MEM_QUEUE_ENGINE:"sqlite",CLAUDE_MEM_REDIS_URL:"",CLAUDE_MEM_REDIS_HOST:"127.0.0.1",CLAUDE_MEM_REDIS_PORT:"6379",CLAUDE_MEM_REDIS_MODE:"external",CLAUDE_MEM_QUEUE_REDIS_PREFIX:`claude_mem_${process.env.CLAUDE_MEM_WORKER_PORT??String(37700+(process.getuid?.()??77)%100)}`,CLAUDE_MEM_AUTH_MODE:"api-key",CLAUDE_MEM_RUNTIME:"worker",CLAUDE_MEM_SERVER_BETA_URL:`http://127.0.0.1:${process.env.CLAUDE_MEM_SERVER_PORT??String(37877+(process.getuid?.()??77)%100)}`,CLAUDE_MEM_SERVER_BETA_API_KEY:"",CLAUDE_MEM_SERVER_BETA_PROJECT_ID:"",CLAUDE_MEM_REDACTION_ENABLED:"true",CLAUDE_MEM_REDACTION_DISABLED_CATEGORIES:"",CLAUDE_MEM_REDACTION_EMAIL_ALLOWLIST:"",CLAUDE_MEM_REDACTION_LOCALE_PATTERNS:"{}",CLAUDE_MEM_REDACTION_PROJECT_OVERRIDES:"{}"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return process.env[e]??this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){let t=this.get(e);return t==="true"||t===!0}static applyEnvOverrides(e){let t={...e};for(let s of Object.keys(this.DEFAULTS))process.env[s]!==void 0&&(t[s]=process.env[s]);return t}static loadFromFile(e,t=!0){try{if(!(0,I.existsSync)(e)){let a=this.getAllDefaults();try{let d=(0,$.dirname)(e);(0,I.existsSync)(d)||(0,I.mkdirSync)(d,{recursive:!0}),(0,I.writeFileSync)(e,JSON.stringify(a,null,2),"utf-8"),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(d){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,d instanceof Error?d.message:String(d))}return t?this.applyEnvOverrides(a):a}let s=(0,I.readFileSync)(e,"utf-8"),n=JSON.parse(s.replace(/^\uFEFF/,"")),o=n;if(n.env&&typeof n.env=="object"){o=n.env;try{(0,I.writeFileSync)(e,JSON.stringify(o,null,2),"utf-8"),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS))o[a]!==void 0&&(i[a]=o[a]);return t?this.applyEnvOverrides(i):i}catch(s){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,s instanceof Error?s.message:String(s));let n=this.getAllDefaults();return t?this.applyEnvOverrides(n):n}}};var H="redaction.local.json",ys=200;function vs(r){return r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Ge(r,e){let t=r[e];return t==="*"||t==="+"?!0:t==="{"&&/^\{\d+,\}/.test(r.slice(e))}function Us(r){if(r.length>ys)return!1;let e=r.replace(/\\./g,"").replace(/\[[^\]]*\]/g,""),t=[];for(let s=0;s<e.length;s++){let n=e[s];if(n==="(")t.push(!1);else if(n===")"){let o=t.pop()??!1,i=Ge(e,s+1);if(i&&o)return!1;t.length>0&&(o||i)&&(t[t.length-1]=!0)}else Ge(e,s)&&t.length>0&&(t[t.length-1]=!0)}return!0}function Ye(r,e,t,s){if(!Us(t))return l.warn("REDACT",`Ignoring ${s} pattern \u2014 source too long or potential ReDoS`,{label:e}),null;try{return{category:r,label:e,regex:new RegExp(t,"g")}}catch{return l.warn("REDACT",`Ignoring ${s} pattern \u2014 invalid regular expression`,{label:e}),null}}function xs(){let r;try{r=(0,Ke.readFileSync)(J.default.join(qe(),H),"utf-8")}catch(s){let n=s.code;return n!=="ENOENT"&&l.warn("REDACT",`Cannot read ${H}; its denylist terms will NOT be redacted`,{code:n}),[]}let e;try{e=JSON.parse(r)}catch{return l.warn("REDACT",`Ignoring ${H} \u2014 invalid JSON`,{}),[]}let t=[];if(Array.isArray(e.terms))for(let s of e.terms)typeof s=="string"&&s.length>0&&t.push({category:"CUSTOM",label:"CUSTOM",regex:new RegExp(vs(s),"g")});if(e.patterns&&typeof e.patterns=="object")for(let[s,n]of Object.entries(e.patterns)){if(!Ve.test(s)){l.warn("REDACT",`Ignoring a ${H} pattern with a non-UPPER_SNAKE label`,{});continue}if(typeof n!="string")continue;let o=Ye("CUSTOM",s,n,H);o&&t.push(o)}return t}var Ve=/^[A-Z][A-Z0-9_]*$/;function qe(){return process.env.CLAUDE_MEM_DATA_DIR||J.default.join(We.default.homedir(),".claude-mem")}function je(r){return r.split(",").map(e=>e.trim()).filter(Boolean)}function Xe(r,e,t){if(!r)return e;try{return JSON.parse(r)}catch{return l.warn("REDACT",`Ignoring ${t} \u2014 invalid JSON`,{}),e}}function Je(r,e){let t=r.toLowerCase(),[s,n]=t.split("@");if(s==="noreply"||s==="no-reply"||n==="example.com"||n==="example.org"||n==="example.net")return!0;for(let o of e){let i=o.toLowerCase();if(i.startsWith("@")&&n===i.slice(1)||i===n||i===t)return!0}return!1}function U(r){let e=v.loadFromFile(J.default.join(qe(),"settings.json")),t=_=>e[_]??"",s=t("CLAUDE_MEM_REDACTION_ENABLED")!=="false",n=new Set;Be(n,je(t("CLAUDE_MEM_REDACTION_DISABLED_CATEGORIES")));let o=je(t("CLAUDE_MEM_REDACTION_EMAIL_ALLOWLIST")),i=Xe(t("CLAUDE_MEM_REDACTION_PROJECT_OVERRIDES"),{},"CLAUDE_MEM_REDACTION_PROJECT_OVERRIDES"),a=r?i[r]:void 0;a&&typeof a=="object"&&(a.enabled===!1&&(s=!1),Array.isArray(a.disabledCategories)&&Be(n,a.disabledCategories),Array.isArray(a.emailAllowlist)&&(o=[...o,...a.emailAllowlist.filter(_=>typeof _=="string")]));let d=Xe(t("CLAUDE_MEM_REDACTION_LOCALE_PATTERNS"),{},"CLAUDE_MEM_REDACTION_LOCALE_PATTERNS"),c=[];for(let[_,u]of Object.entries(d)){if(!Ve.test(_)){l.warn("REDACT","Ignoring configured locale pattern with invalid label (must be UPPER_SNAKE)",{label:_});continue}if(typeof u!="string"){l.warn("REDACT","Ignoring configured locale pattern with non-string source",{label:_});continue}let T=Ye("NATIONAL_ID",_,u,"configured locale");T&&c.push(T)}return c.push(...xs()),{enabled:s,disabled:n,emailAllowlist:o,localePatterns:c}}function Be(r,e){for(let t of e)ye(t)?r.add(t):l.warn("REDACT","Ignoring unknown redaction category in config",{category:t})}function z(r,e,t){return e.regex.lastIndex=0,r.replace(e.regex,(...s)=>{let n=s[0],o=e.replace?e.replace(...s):`[REDACTED:${e.label}]`;return o!==n&&(t[e.label]=(t[e.label]??0)+1),o})}function M(r,e={}){if(typeof r!="string"||r.length===0)return{text:typeof r=="string"?r:"",counts:{}};let t=e.config??U(e.project);if(!t.enabled)return{text:r,counts:{}};let s={},n=r;try{for(let o of $e())n=z(n,o,s);for(let o of[...we,...t.localePatterns])t.disabled.has(o.category)||(n=z(n,o,s));t.disabled.has("EMAIL")||(le.lastIndex=0,n=n.replace(le,o=>Je(o,t.emailAllowlist)?o:(s.EMAIL=(s.EMAIL??0)+1,"[REDACTED:EMAIL]"))),t.disabled.has("PHONE")||(n=z(n,{category:"PHONE",label:"PHONE",regex:xe,replace:Ue},s)),t.disabled.has("POSTAL")||(n=z(n,{category:"POSTAL",label:"POSTAL_ADDRESS",regex:Pe},s))}catch{return{text:"[REDACTED:ERROR]",counts:{ERROR:1}}}return{text:n,counts:s}}var ge=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(ge||{}),me=null,Te=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=G.logsDir();(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,ze.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=G.settings();if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=ge[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){return this.redactForLog(this.formatToolRaw(e,t))}redactionConfig=null;redactForLog(e){try{return this.redactionConfig??=U(),M(e,{config:this.redactionConfig}).text}catch{return"[LOG_REDACTION_FAILED]"}}formatToolRaw(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=ge[e].padEnd(5),d=t.padEnd(6),c="";n?.correlationId?c=`[${n.correlationId}] `:n?.sessionId&&(c=`[session-${n.sessionId}] `);let _="";if(o!=null)if(o instanceof Error)_=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{_=`
`+JSON.stringify(o,null,2)}catch{_=" "+this.formatData(o)}else _=" "+this.formatData(o);let u="";if(n){let{sessionId:p,memorySessionId:S,correlationId:O,...A}=n;Object.keys(A).length>0&&(u=` {${Object.entries(A).map(([m,f])=>`${m}=${f}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${c}${s}${u}${_}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,T+`
`,"utf8")}catch(p){_e(`[LOGGER] Failed to write to log file: ${p instanceof Error?p.message:String(p)}
`)}else _e(T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",u={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},l=new Te;var Bs={};function Ps(){return typeof __dirname<"u"?__dirname:(0,g.dirname)((0,Ze.fileURLToPath)(Bs.url))}var ws=Ps();function ks(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,g.join)((0,fe.homedir)(),".claude-mem"),e=(0,g.join)(r,"settings.json");try{if((0,x.existsSync)(e)){let t=JSON.parse((0,x.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var b=ks(),P=process.env.CLAUDE_CONFIG_DIR||(0,g.join)((0,fe.homedir)(),".claude"),wr=(0,g.join)(P,"plugins","marketplaces","thedotmack"),Fs=(0,g.join)(b,"archives"),$s=(0,g.join)(b,"logs"),Hs=(0,g.join)(b,"trash"),Gs=(0,g.join)(b,"backups"),js=(0,g.join)(b,"modes"),kr=(0,g.join)(b,"settings.json"),Qe=(0,g.join)(b,"claude-mem.db"),Xs=(0,g.join)(b,"vector-db"),et=(0,g.join)(b,"observer-sessions"),Se=(0,g.basename)(et);var Fr=(0,g.join)(P,"settings.json"),$r=(0,g.join)(P,"commands"),Hr=(0,g.join)(P,"CLAUDE.md");function tt(r){(0,x.mkdirSync)(r,{recursive:!0})}function st(){return(0,g.join)(ws,"..")}var G={dataDir:()=>b,workerPid:()=>(0,g.join)(b,"worker.pid"),serverBetaPid:()=>(0,g.join)(b,".server-beta.pid"),serverBetaPort:()=>(0,g.join)(b,".server-beta.port"),serverBetaRuntime:()=>(0,g.join)(b,".server-beta.runtime.json"),settings:()=>(0,g.join)(b,"settings.json"),database:()=>(0,g.join)(b,"claude-mem.db"),chroma:()=>(0,g.join)(b,"chroma"),combinedCerts:()=>(0,g.join)(b,"combined_certs.pem"),transcriptsConfig:()=>(0,g.join)(b,"transcript-watch.json"),transcriptsState:()=>(0,g.join)(b,"transcript-watch-state.json"),corpora:()=>(0,g.join)(b,"corpora"),supervisorRegistry:()=>(0,g.join)(b,"supervisor.json"),envFile:()=>(0,g.join)(b,".env"),logsDir:()=>$s,archives:()=>Fs,trash:()=>Hs,backups:()=>Gs,modes:()=>js,vectorDb:()=>Xs,observerSessions:()=>et};var rt=require("crypto");function Ae(r,e,t){return(0,rt.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Re(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function Ws(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function w(r){if(!r)return h;let e=Ws(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function nt(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function ot(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(e,t,n)??void 0}var dt=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],it=new RegExp(`<(${dt.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),_t=/<system-reminder>[\s\S]*?<\/system-reminder>/g,at=100;function Ks(r){let e=Object.fromEntries(dt.map(n=>[n,0]));it.lastIndex=0;let t=0,s=r.replace(it,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>at&&l.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:at,contentLength:r.length}),{stripped:s.trim(),counts:e}}function lt(r){return Ks(r).stripped}var Ys=["task-notification"],Vr=new RegExp(`^\\s*<(${Ys.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),qr=256*1024;var be=4e3;function Z(r){let e=r.trim(),s=lt(r).trim()||e;return s.length<=be?s:(l.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:be}),`${s.slice(0,be-1)}\u2026`)}function ct(r,e,t){Object.values(t).reduce((n,o)=>n+o,0)>0&&l.info("REDACT","redaction applied",{surface:r,project:e,counts:t})}function L(r,e={}){let{text:t,counts:s}=M(r,{project:e.project});return ct(e.surface??"persist",e.project,s),t}function j(r,e,t={}){let s={},n={...r},o={project:t.project,config:U(t.project)};for(let i of e){let a=n[i];if(typeof a=="string"){let{text:d,counts:c}=M(a,o);n[i]=d;for(let[_,u]of Object.entries(c))s[_]=(s[_]??0)+u}else Array.isArray(a)&&(n[i]=a.map(d=>{if(typeof d!="string")return d;let{text:c,counts:_}=M(d,o);for(let[u,T]of Object.entries(_))s[u]=(s[u]??0)+T;return c}))}return ct(t.surface??"persist",t.project,s),n}function Vs(r,e){return{customTitle:r,platformSource:e?w(e):void 0}}var Q=class{db;constructor(e=Qe){e instanceof Oe.Database?this.db=e:(e!==":memory:"&&tt(b),this.db=new Oe.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensurePendingMessagesAgentColumns(),this.ensureSessionsConversationHistoryColumn()}ensureSessionsConversationHistoryColumn(){this.db.query("PRAGMA table_info(sdk_sessions)").all().some(t=>t.name==="conversation_history")||this.db.run("ALTER TABLE sdk_sessions ADD COLUMN conversation_history TEXT")}saveConversationHistory(e,t){this.db.prepare("UPDATE sdk_sessions SET conversation_history = ? WHERE id = ?").run(t,e)}getConversationHistory(e){return this.db.prepare("SELECT conversation_history FROM sdk_sessions WHERE id = ?").get(e)?.conversation_history??null}ensurePendingMessagesAgentColumns(){let e=this.db.query("PRAGMA table_info(pending_messages)").all(),t=new Set(e.map(s=>s.name));t.has("agent_id")||this.db.run("ALTER TABLE pending_messages ADD COLUMN agent_id TEXT"),t.has("agent_type")||this.db.run("ALTER TABLE pending_messages ADD COLUMN agent_type TEXT")}insertPendingMessage(e){let t=this.db.prepare(`
    ...
    `).all(Se),t=[],s=new Set,n={};for(let i of e){let a=w(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=nt(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(e)}findRecentDuplicateUserPrompt(e,t,s){return ot(this.db,e,Z(t),s)}getRecentSessionsWithStatus(e,t=3){return this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="relevance",_=c?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,u=n?`LIMIT ${n}`:"",T=e.map(()=>"?").join(","),p=[...e],S=[];if(o&&(S.push("project = ?"),p.push(o)),i)if(Array.isArray(i)){let f=i.map(()=>"?").join(",");S.push(`type IN (${f})`),p.push(...i)}else S.push("type = ?"),p.push(i);if(a){let f=Array.isArray(a)?a:[a],y=f.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");p.push(...f),S.push(`(${y.join(" OR ")})`)}if(d){let f=Array.isArray(d)?d:[d],y=f.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");f.forEach(F=>{p.push(`%${F}%`,`%${F}%`)}),S.push(`(${y.join(" OR ")})`)}let O=S.length>0?`WHERE id IN (${T}) AND ${S.join(" AND ")}`:`WHERE id IN (${T})`,R=this.db.prepare(`
      SELECT *
      FROM observations
      ${O}
      ${_}
      ${u}
    `).all(...p);if(!c)return R;let m=new Map(R.map(f=>[f.id,f]));return e.map(f=>m.get(f)).filter(f=>!!f)}getSummaryForSession(e){return this.db.prepare(`
      SELECT
        request, investigated, learned, completed, next_steps,
        files_read, files_edited, notes, prompt_number, created_at,
        created_at_epoch
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Vs(n,o),c=d.platformSource??h,_=L(Z(s),{project:t,surface:"sqlite"}),u=d.customTitle?L(d.customTitle,{project:t,surface:"sqlite"}):d.customTitle,T=this.db.prepare(`
    ...
    `).get(e);if(T){if(t&&this.db.prepare(`
        ...
        `).run(u,e),d.platformSource){let S=T.platform_source?.trim()?w(T.platform_source):void 0;if(!S)this.db.prepare(`
            UPDATE sdk_sessions SET platform_source = ?
            WHERE content_session_id = ?
              AND COALESCE(platform_source, '') = ''
          `).run(d.platformSource,e);else if(S!==d.platformSource)throw new Error(`Platform source conflict for session ${e}: existing=${S}, received=${d.platformSource}`)}return T.id}return this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,_,u||null,i.toISOString(),a),this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e).id}saveUserPrompt(e,t,s){let n=new Date,o=n.getTime(),i=L(Z(s),{surface:"sqlite"});return this.db.prepare(`
    ...
    `).run(e,t,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),_=j(s,["title","subtitle","narrative","facts","concepts","metadata"],{project:t,surface:"sqlite"}),u=Ae(e,_.title,_.narrative),p=this.db.prepare(`
    ...
    `).get(e,t,_.type,_.title,_.subtitle,JSON.stringify(_.facts),_.narrative,JSON.stringify(_.concepts),JSON.stringify(_.files_read),JSON.stringify(_.files_modified),n||null,o,_.agent_type??null,_.agent_id??null,u,c,d,a||null,_.metadata??null);if(p)return{id:p.id,createdAtEpoch:p.created_at_epoch};let S=this.db.prepare("SELECT id, created_at_epoch FROM observations WHERE memory_session_id = ? AND content_hash = ?").get(e,u);if(!S)throw new Error(`storeObservation: ON CONFLICT without existing row for content_hash=${u}`);return{id:S.id,createdAtEpoch:S.created_at_epoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=j(s,["request","investigated","learned","completed","next_steps","notes"],{project:t,surface:"sqlite"}),u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,c.request,c.investigated,c.learned,c.completed,c.next_steps,c.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d,c){let _=a??Date.now(),u=new Date(_).toISOString();return this.db.transaction(()=>{let p=[],S=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, agent_type, agent_id, content_hash, created_at, created_at_epoch,
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),O=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let R of s){let m=j(R,["title","subtitle","narrative","facts","concepts"],{project:t,surface:"sqlite"}),f=Ae(e,m.title,m.narrative),y=S.get(e,t,m.type,m.title,m.subtitle,JSON.stringify(m.facts),m.narrative,JSON.stringify(m.concepts),JSON.stringify(m.files_read),JSON.stringify(m.files_modified),o||null,i,m.agent_type??null,m.agent_id??null,f,u,_,d||null,c||null);if(y){p.push(y.id);continue}let F=O.get(e,f);if(!F)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${f}`);p.push(F.id)}let A=null;if(n){let R=j(n,["request","investigated","learned","completed","next_steps","notes"],{project:t,surface:"sqlite"}),f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           generated_by_provider)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,R.request,R.investigated,R.learned,R.completed,R.next_steps,R.notes,o||null,i,u,_,c||null);A=Number(f.lastInsertRowid)}return{observationIds:p,summaryId:A,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),_=[...e],u=o?`WHERE id IN (${c}) AND project = ?`:`WHERE id IN (${c})`;o&&_.push(o);let p=this.db.prepare(`
      SELECT * FROM session_summaries
      ${u}
      ${a}
      ${d}
    `).all(..._);if(!i)return p;let S=new Map(p.map(O=>[O.id,O]));return e.map(O=>S.get(O)).filter(O=>!!O)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),_=[...e],u=o?"AND s.project = ?":"";o&&_.push(o);let p=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id
      ...
      ${a}
      ${d}
    `).all(..._);if(!i)return p;let S=new Map(p.map(O=>[O.id,O]));return e.map(O=>S.get(O)).filter(O=>!!O)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let A=`
      ...
      `,R=`
        ...
        ORDER BY id ASC
        LIMIT ?
      `;try{let m=this.db.prepare(A).all(e,...a,s+1),f=this.db.prepare(R).all(e,...a,n+1);if(m.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=m.length>0?m[m.length-1].created_at_epoch:t,c=f.length>0?f[f.length-1].created_at_epoch:t}catch(m){return m instanceof Error?l.error("DB","Error getting boundary observations",{project:o},m):l.error("DB","Error getting boundary observations with non-Error",{},new Error(String(m))),{observations:[],sessions:[],prompts:[]}}}else{let A=`
      ...
      `,R=`
        ...
        ORDER BY created_at_epoch ASC
        LIMIT ?
      `;try{let m=this.db.prepare(A).all(t,...a,s),f=this.db.prepare(R).all(t,...a,n+1);if(m.length===0&&f.length===0)return{observations:[],sessions:[],prompts:[]};d=m.length>0?m[m.length-1].created_at_epoch:t,c=f.length>0?f[f.length-1].created_at_epoch:t}catch(m){return m instanceof Error?l.error("DB","Error getting boundary timestamps",{project:o},m):l.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(m))),{observations:[],sessions:[],prompts:[]}}}let _=`
      SELECT *
      FROM observations
    ...
    `,p=this.db.prepare(_).all(d,c,...a),S=this.db.prepare(u).all(d,c,...a),O=this.db.prepare(T).all(d,c,...a);return{observations:p,sessions:S.map(A=>({id:A.id,memory_session_id:A.memory_session_id,project:A.project,request:A.request,completed:A.completed,next_steps:A.next_steps,created_at:A.created_at,created_at_epoch:A.created_at_epoch})),prompts:O.map(A=>({id:A.id,content_session_id:A.content_session_id,prompt_number:A.prompt_number,prompt_text:A.prompt_text,project:A.project,created_at:A.created_at,created_at_epoch:A.created_at_epoch}))}}getPromptById(e){return this.db.prepare(`
      SELECT
        p.id,
    ...
    `).run(e.content_session_id,e.prompt_number,L(e.prompt_text,{surface:"sqlite"}),e.created_at,e.created_at_epoch).lastInsertRowid}}};var ut=require("os"),pt=D(require("path"),1),mt=require("child_process");var te=require("fs"),ee=D(require("path"),1);var X={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function Et(r){let e=ee.default.join(r,".git"),t;try{t=(0,te.statSync)(e)}catch(_){return _ instanceof Error&&_.code!=="ENOENT"&&l.warn("GIT","Unexpected error checking .git",{error:_ instanceof Error?_.message:String(_)}),X}if(!t.isFile())return X;let s;try{s=(0,te.readFileSync)(e,"utf-8").trim()}catch(_){return l.warn("GIT","Failed to read .git file",{error:_ instanceof Error?_.message:String(_)}),X}let n=s.match(/^gitdir:\s*(.+)$/);if(!n)return X;let i=n[1].match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return X;let a=i[1],d=ee.default.basename(r),c=ee.default.basename(a);return{isWorktree:!0,worktreeName:d,parentRepoPath:a,parentProjectName:c}}function gt(r){return r==="~"||r.startsWith("~/")?r.replace(/^~/,(0,ut.homedir)()):r}function qs(r){try{return(0,mt.execFileSync)("git",["rev-parse","--show-toplevel"],{cwd:r,encoding:"utf-8",stdio:["ignore","pipe","ignore"]}).trim()||null}catch{return null}}function Js(r){if(!r||r.trim()==="")return l.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:r}),"unknown-project";let e=gt(r),s=qs(e)??e,n=pt.default.basename(s);if(n===""){if(process.platform==="win32"){let i=r.match(/^([A-Z]):\\/i);if(i){let d=`drive-${i[1].toUpperCase()}`;return l.info("PROJECT_NAME","Drive root detected",{cwd:r,projectName:d}),d}}return l.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:r}),"unknown-project"}return n}function Tt(r){let e=Js(r);if(!r)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let t=gt(r),s=Et(t);if(s.isWorktree&&s.parentProjectName){let n=`${s.parentProjectName}/${e}`;return{primary:n,parent:s.parentProjectName,isWorktree:!0,allProjects:[s.parentProjectName,n]}}return{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}var B=require("fs"),se=require("path");var C=class r{static instance=null;activeMode=null;modesDir;constructor(){let e=st(),t=[...process.env.CLAUDE_MEM_MODES_DIR?[process.env.CLAUDE_MEM_MODES_DIR]:[],(0,se.join)(e,"modes"),(0,se.join)(e,"..","plugin","modes")],s=t.find(n=>(0,B.existsSync)(n));this.modesDir=s||t[0]}static getInstance(){return r.instance||(r.instance=new r),r.instance}parseInheritance(e){let t=e.split("--");if(t.length===1)return{hasParent:!1,parentId:"",overrideId:""};if(t.length>2)throw new Error(`Invalid mode inheritance: ${e}. Only one level of inheritance supported (parent--override)`);return{hasParent:!0,parentId:t[0],overrideId:e}}isPlainObject(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}deepMerge(e,t){let s={...e};for(let n in t){let o=t[n],i=e[n];this.isPlainObject(o)&&this.isPlainObject(i)?s[n]=this.deepMerge(i,o):s[n]=o}return s}loadModeFile(e){let t=(0,se.join)(this.modesDir,`${e}.json`);if(!(0,B.existsSync)(t))throw new Error(`Mode file not found: ${t}`);let s=(0,B.readFileSync)(t,"utf-8");return JSON.parse(s)}loadMode(e){let t=this.parseInheritance(e);if(!t.hasParent)try{let d=this.loadModeFile(e);return this.activeMode=d,l.debug("SYSTEM",`Loaded mode: ${d.name} (${e})`,void 0,{types:d.observation_types.map(c=>c.id),concepts:d.observation_concepts.map(c=>c.id)}),d}catch(d){if(d instanceof Error?l.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{message:d.message}):l.warn("WORKER",`Mode file not found: ${e}, falling back to 'code'`,{error:String(d)}),e==="code")throw new Error("Critical: code.json mode file missing");return this.loadMode("code")}let{parentId:s,overrideId:n}=t,o;try{o=this.loadMode(s)}catch(d){d instanceof Error?l.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{message:d.message}):l.warn("WORKER",`Parent mode '${s}' not found for ${e}, falling back to 'code'`,{error:String(d)}),o=this.loadMode("code")}let i;try{i=this.loadModeFile(n),l.debug("SYSTEM",`Loaded override file: ${n} for parent ${s}`)}catch(d){return d instanceof Error?l.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{message:d.message}):l.warn("WORKER",`Override file '${n}' not found, using parent mode '${s}' only`,{error:String(d)}),this.activeMode=o,o}if(!i)return l.warn("SYSTEM",`Invalid override file: ${n}, using parent mode '${s}' only`),this.activeMode=o,o;let a=this.deepMerge(o,i);return this.activeMode=a,l.debug("SYSTEM",`Loaded mode with inheritance: ${a.name} (${e} = ${s} + ${n})`,void 0,{parent:s,override:n,types:a.observation_types.map(d=>d.id),concepts:a.observation_concepts.map(d=>d.id)}),a}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}};function ft(){let r=G.settings(),e=v.loadFromFile(r),t=C.getInstance().getActiveMode(),s=new Set(t.observation_types.map(o=>o.id)),n=new Set(t.observation_concepts.map(o=>o.id));return{totalObservationCount:parseInt(e.CLAUDE_MEM_CONTEXT_OBSERVATIONS,10),fullObservationCount:parseInt(e.CLAUDE_MEM_CONTEXT_FULL_COUNT,10),sessionCount:parseInt(e.CLAUDE_MEM_CONTEXT_SESSION_COUNT,10),showReadTokens:e.CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS==="true",showWorkTokens:e.CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS==="true",showSavingsAmount:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT==="true",showSavingsPercent:e.CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT==="true",observationTypes:s,observationConcepts:n,fullObservationField:e.CLAUDE_MEM_CONTEXT_FULL_FIELD,showLastSummary:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY==="true",showLastMessage:e.CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE==="true"}}var E={reset:"\x1B[0m",bright:"\x1B[1m",dim:"\x1B[2m",cyan:"\x1B[36m",green:"\x1B[32m",yellow:"\x1B[33m",blue:"\x1B[34m",magenta:"\x1B[35m",gray:"\x1B[90m",red:"\x1B[31m"},St=4,he=1;function At(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/St)}function Ce(r){let e=r.length,t=r.reduce((i,a)=>i+At(a),0),s=r.reduce((i,a)=>i+(a.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function zs(r){return C.getInstance().getWorkEmoji(r)}function W(r,e){let t=At(r),s=r.discovery_tokens||0,n=zs(r.type),o=s>0?`${n} ${s.toLocaleString()}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function k(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}var Rt=D(require("path"),1),re=require("fs");function bt(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ot(r,e,t){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+he)}function ht(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,...s,...o,t.totalObservationCount)}function Ct(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      ss.id,
      ss.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t.sessionCount+he)}function Zs(r){return r.replace(/[/.]/g,"-")}function Qs(r){if(!r.includes('"type":"assistant"'))return null;let e=JSON.parse(r);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let t="";for(let s of e.message.content)s.type==="text"&&(t+=s.text);if(t=t.replace(_t,"").trim(),t)return t}return null}function er(r){for(let e=r.length-1;e>=0;e--)try{let t=Qs(r[e]);if(t)return t}catch(t){t instanceof Error?l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},t):l.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(t)});continue}return""}function tr(r){try{if(!(0,re.existsSync)(r))return{assistantMessage:""};let e=(0,re.readFileSync)(r,"utf-8").trim();if(!e)return{assistantMessage:""};let t=e.split(`
`).filter(n=>n.trim());return{assistantMessage:er(t)}}catch(e){return e instanceof Error?l.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r},e):l.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:r,error:String(e)}),{assistantMessage:""}}}function It(r,e,t,s){if(!e.showLastMessage||r.length===0)return{assistantMessage:""};let n=r.find(d=>d.memory_session_id!==t);if(!n)return{assistantMessage:""};let o=n.memory_session_id,i=Zs(s),a=Rt.default.join(P,"projects",i,`${o}.jsonl`);return tr(a)}function Nt(r,e){let t=e[0]?.id;return r.map((s,n)=>{let o=n===0?null:e[n+1];return{...s,displayEpoch:o?o.created_at_epoch:s.created_at_epoch,displayTime:o?o.created_at:s.created_at,shouldShowLink:s.id!==t}})}function Lt(r,e){let t=[...r.map(s=>({type:"observation",data:s})),...e.map(s=>({type:"summary",data:s}))];return t.sort((s,n)=>{let o=s.type==="observation"?s.data.created_at_epoch:s.data.displayEpoch,i=n.type==="observation"?n.data.created_at_epoch:n.data.displayEpoch;return o-i}),t}function Dt(r,e){return new Set(r.slice(0,e).map(t=>t.id))}function Mt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function yt(r){return[`# [${r}] recent context, ${Mt()}`,""]}function vt(){return[`Legend: \u{1F3AF}session ${C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji}${t.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function ne(r,e){let t=[],s=[`${r.totalObservations} obs (${r.totalReadTokens.toLocaleString()}t read)`,`${r.totalDiscoveryTokens.toLocaleString()}t work`];return r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?s.push(`${r.savingsPercent}% savings`):e.showSavingsAmount&&s.push(`${r.savings.toLocaleString()}t saved`)),t.push(`Stats: ${s.join(" | ")}`),t.push(""),t}function Ut(r){return[`### ${r}`]}function xt(r){return r.toLowerCase().replace(" am","a").replace(" pm","p")}function Pt(r,e,t){let s=r.title||"Untitled",n=C.getInstance().getTypeIcon(r.type),o=e?xt(e):'"';return`${r.id} ${o} ${n} ${s}`}function wt(r,e,t,s){let n=[],o=r.title||"Untitled",i=C.getInstance().getTypeIcon(r.type),a=e?xt(e):'"',{readTokens:d,discoveryDisplay:c}=W(r,s);n.push(`**${r.id}** ${a} ${i} **${o}**`),t&&n.push(t);let _=[];return s.showReadTokens&&_.push(`~${d}t`),s.showWorkTokens&&_.push(c),_.length>0&&n.push(_.join(" ")),n.push(""),n}function kt(r,e){return[`S${r.id} ${r.request||"Session started"} (${e})`]}function K(r,e){return e?[`**${r}**: ${e}`,""]:[]}function Ft(r){return r.assistantMessage?["","---","","**Previously**","",`A: ${r.assistantMessage}`,""]:[]}function $t(r,e){return["",`Access ${Math.round(r/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function Ht(r){return`# [${r}] recent context, ${Mt()}

No previous sessions found.`}function Gt(){let r=new Date,e=r.toLocaleDateString("en-CA"),t=r.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),s=r.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${t} ${s}`}function jt(r){return["",`${E.bright}${E.cyan}[${r}] recent context, ${Gt()}${E.reset}`,`${E.gray}${"\u2500".repeat(60)}${E.reset}`,""]}function Xt(){let e=C.getInstance().getActiveMode().observation_types.map(t=>`${t.emoji} ${t.id}`).join(" | ");return[`${E.dim}Legend: session-request | ${e}${E.reset}`,""]}function Bt(){return[`${E.bright}Column Key${E.reset}`,`${E.dim}  Read: Tokens to read this observation (cost to learn it now)${E.reset}`,`${E.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${E.reset}`,""]}function Wt(){return[`${E.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${E.reset}`,"",`${E.dim}When you need implementation details, rationale, or debugging context:${E.reset}`,`${E.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${E.reset}`,`${E.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${E.reset}`,`${E.dim}  - Trust this index over re-reading code for past decisions and learnings${E.reset}`,""]}function ie(r,e){let t=[];if(t.push(`${E.bright}${E.cyan}Context Economics${E.reset}`),t.push(`${E.dim}  Loading: ${r.totalObservations} observations (${r.totalReadTokens.toLocaleString()} tokens to read)${E.reset}`),t.push(`${E.dim}  Work investment: ${r.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${E.reset}`),r.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let s="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?s+=`${r.savings.toLocaleString()} tokens (${r.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?s+=`${r.savings.toLocaleString()} tokens`:s+=`${r.savingsPercent}% reduction from reuse`,t.push(`${E.green}${s}${E.reset}`)}return t.push(""),t}function Kt(r){return[`${E.bright}${E.cyan}${r}${E.reset}`,""]}function Yt(r){return[`${E.dim}${r}${E.reset}`]}function Vt(r,e,t,s){let n=r.title||"Untitled",o=C.getInstance().getTypeIcon(r.type),{readTokens:i,discoveryTokens:a,workEmoji:d}=W(r,s),c=t?`${E.dim}${e}${E.reset}`:" ".repeat(e.length),_=s.showReadTokens&&i>0?`${E.dim}(~${i}t)${E.reset}`:"",u=s.showWorkTokens&&a>0?`${E.dim}(${d} ${a.toLocaleString()}t)${E.reset}`:"";return`  ${E.dim}#${r.id}${E.reset}  ${c}  ${o}  ${n} ${_} ${u}`}function qt(r,e,t,s,n){let o=[],i=r.title||"Untitled",a=C.getInstance().getTypeIcon(r.type),{readTokens:d,discoveryTokens:c,workEmoji:_}=W(r,n),u=t?`${E.dim}${e}${E.reset}`:" ".repeat(e.length),T=n.showReadTokens&&d>0?`${E.dim}(~${d}t)${E.reset}`:"",p=n.showWorkTokens&&c>0?`${E.dim}(${_} ${c.toLocaleString()}t)${E.reset}`:"";return o.push(`  ${E.dim}#${r.id}${E.reset}  ${u}  ${a}  ${E.bright}${i}${E.reset}`),s&&o.push(`    ${E.dim}${s}${E.reset}`),(T||p)&&o.push(`    ${T} ${p}`),o.push(""),o}function Jt(r,e){let t=`${r.request||"Session started"} (${e})`;return[`${E.yellow}#S${r.id}${E.reset} ${t}`,""]}function Y(r,e,t){return e?[`${t}${r}:${E.reset} ${e}`,""]:[]}function zt(r){return r.assistantMessage?["","---","",`${E.bright}${E.magenta}Previously${E.reset}`,"",`${E.dim}A: ${r.assistantMessage}${E.reset}`,""]:[]}function Zt(r,e){let t=Math.round(r/1e3);return["",`${E.dim}Access ${t}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${E.reset}`]}function Qt(r){return`
${E.bright}${E.cyan}[${r}] recent context, ${Gt()}${E.reset}
${E.gray}${"\u2500".repeat(60)}${E.reset}

${E.dim}No previous sessions found for this project yet.${E.reset}
`}function es(r,e,t,s){let n=[];return s?n.push(...jt(r)):n.push(...yt(r)),s?n.push(...Xt()):n.push(...vt()),s&&(n.push(...Bt()),n.push(...Wt())),k(t)&&(s?n.push(...ie(e,t)):n.push(...ne(e,t))),n}var Ie=D(require("path"),1);function de(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return l.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Ne(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Le(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ss(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ts(r,e){return Ie.default.isAbsolute(r)?Ie.default.relative(e,r):r}function rs(r,e,t){let s=de(r);if(s.length>0)return ts(s[0],e);if(t){let n=de(t);if(n.length>0)return ts(n[0],e)}return"General"}function sr(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ss(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function ns(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?de(r.facts).join(`
`):null}function rr(r,e,t,s){let n=[];n.push(...Ut(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Ne(a.displayTime);n.push(...kt(a,d))}else{let a=i.data,d=Le(a.created_at),_=d!==o?d:"";if(o=d,t.has(a.id)){let T=ns(a,s);n.push(...wt(a,_,T,s))}else n.push(Pt(a,_,s))}return n}function nr(r,e,t,s,n){let o=[];o.push(...Kt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,_=Ne(c.displayTime);o.push(...Jt(c,_))}else{let c=d.data,_=rs(c.files_modified,n,c.files_read),u=Le(c.created_at),T=u!==a;a=u;let p=t.has(c.id);if(_!==i&&(o.push(...Yt(_)),i=_),p){let S=ns(c,s);o.push(...qt(c,u,T,S,s))}else o.push(Vt(c,u,T,s))}return o.push(""),o}function or(r,e,t,s,n,o){return o?nr(r,e,t,s,n):rr(r,e,t,s)}function os(r,e,t,s,n){let o=[],i=sr(r);for(let[a,d]of i)o.push(...or(a,d,e,t,s,n));return o}function is(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function as(r,e){let t=[];return e?(t.push(...Y("Investigated",r.investigated,E.blue)),t.push(...Y("Learned",r.learned,E.yellow)),t.push(...Y("Completed",r.completed,E.green)),t.push(...Y("Next Steps",r.next_steps,E.magenta))):(t.push(...K("Investigated",r.investigated)),t.push(...K("Learned",r.learned)),t.push(...K("Completed",r.completed)),t.push(...K("Next Steps",r.next_steps))),t}function ds(r,e){return e?zt(r):Ft(r)}function _s(r,e,t){return!k(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Zt(r.totalDiscoveryTokens,r.totalReadTokens):$t(r.totalDiscoveryTokens,r.totalReadTokens)}var ir=ls.default.join((0,cs.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ar(){try{return new Q}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Es.unlinkSync)(ir)}catch(e){e instanceof Error?l.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):l.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return l.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function dr(r,e){return e?Qt(r):Ht(r)}function _r(r,e,t,s,n,o,i,a=!1){let d=[],c=Ce(e);if(a)return k(s)?(i?ie(c,s):ne(c,s)).join(`
`).trimEnd():"";d.push(...es(r,c,s,i));let _=t.slice(0,s.sessionCount),u=Nt(_,t),T=Lt(e,u),p=Dt(e,s.fullObservationCount);d.push(...os(T,p,s,n,i));let S=t[0],O=e[0];is(s,S,O)&&d.push(...as(S,i));let A=It(e,s,o,n);return d.push(...ds(A,i)),d.push(..._s(c,s,i)),d.join(`
`).trimEnd()}var lr=new Set(["bugfix","discovery","decision","refactor"]);function cr(r,e,t){let s=Ce(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=lr.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function De(r,e=!1){let t=ft(),s=r?.cwd??process.cwd(),n=Tt(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ar();if(!a)return{text:"",stats:null};try{let d=o.length>1?ht(a,o,t):bt(a,i,t),c=o.length>1?Ct(a,o,t):Ot(a,i,t);return d.length===0&&c.length===0?{text:dr(i,e),stats:null}:{text:_r(i,d,c,t,s,r?.session_id,e,r?.economicsOnly),stats:cr(d,c,!!r?.full)}}finally{a.close()}}async function us(r,e=!1){return(await De(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
