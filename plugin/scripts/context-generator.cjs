...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",u={...s,location:l};return this.warn(e,`[HAPPY-PATH] ${t}`,u,n),o}},_=new ge;var Bs={};function Ps(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,Ze.fileURLToPath)(Bs.url))}var ws=Ps();function ks(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,T.join)((0,Te.homedir)(),".claude-mem"),e=(0,T.join)(r,"settings.json");try{if((0,x.existsSync)(e)){let t=JSON.parse((0,x.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var O=ks(),P=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,Te.homedir)(),".claude"),wr=(0,T.join)(P,"plugins","marketplaces","thedotmack"),Fs=(0,T.join)(O,"archives"),$s=(0,T.join)(O,"logs"),Hs=(0,T.join)(O,"trash"),Gs=(0,T.join)(O,"backups"),js=(0,T.join)(O,"modes"),kr=(0,T.join)(O,"settings.json"),Qe=(0,T.join)(O,"claude-mem.db"),Xs=(0,T.join)(O,"vector-db"),et=(0,T.join)(O,"observer-sessions"),fe=(0,T.basename)(et);var Fr=(0,T.join)(P,"settings.json"),$r=(0,T.join)(P,"commands"),Hr=(0,T.join)(P,"CLAUDE.md");function tt(r){(0,x.mkdirSync)(r,{recursive:!0})}function st(){return(0,T.join)(ws,"..")}var H={dataDir:()=>O,workerPid:()=>(0,T.join)(O,"worker.pid"),serverBetaPid:()=>(0,T.join)(O,".server-beta.pid"),serverBetaPort:()=>(0,T.join)(O,".server-beta.port"),serverBetaRuntime:()=>(0,T.join)(O,".server-beta.runtime.json"),settings:()=>(0,T.join)(O,"settings.json"),database:()=>(0,T.join)(O,"claude-mem.db"),chroma:()=>(0,T.join)(O,"chroma"),combinedCerts:()=>(0,T.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(O,"transcript-watch-state.json"),corpora:()=>(0,T.join)(O,"corpora"),supervisorRegistry:()=>(0,T.join)(O,"supervisor.json"),envFile:()=>(0,T.join)(O,".env"),logsDir:()=>$s,archives:()=>Fs,trash:()=>Hs,backups:()=>Gs,modes:()=>js,vectorDb:()=>Xs,observerSessions:()=>et};var rt=require("crypto");function Se(r,e,t){return(0,rt.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function Ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function Ws(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function w(r){if(!r)return h;let e=Ws(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function nt(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function ot(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(e,t,n)??void 0}var dt=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],it=new RegExp(`<(${dt.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),_t=/<system-reminder>[\s\S]*?<\/system-reminder>/g,at=100;function Ks(r){let e=Object.fromEntries(dt.map(n=>[n,0]));it.lastIndex=0;let t=0,s=r.replace(it,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>at&&_.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:at,contentLength:r.length}),{stripped:s.trim(),counts:e}}function lt(r){return Ks(r).stripped}var Ys=["task-notification"],Vr=new RegExp(`^\\s*<(${Ys.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),qr=256*1024;var Re=4e3;function z(r){let e=r.trim(),s=lt(r).trim()||e;return s.length<=Re?s:(_.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:Re}),`${s.slice(0,Re-1)}\u2026`)}function ct(r,e,t){Object.values(t).reduce((n,o)=>n+o,0)>0&&_.info("REDACT","redaction applied",{surface:r,project:e,counts:t})}function L(r,e={}){let{text:t,counts:s}=M(r,{project:e.project});return ct(e.surface??"persist",e.project,s),t}function G(r,e,t={}){let s={},n={...r},o={project:t.project,config:U(t.project)};for(let i of e){let a=n[i];if(typeof a=="string"){let{text:d,counts:c}=M(a,o);n[i]=d;for(let[l,u]of Object.entries(c))s[l]=(s[l]??0)+u}else Array.isArray(a)&&(n[i]=a.map(d=>{if(typeof d!="string")return d;let{text:c,counts:l}=M(d,o);for(let[u,m]of Object.entries(l))s[u]=(s[u]??0)+m;return c}))}return ct(t.surface??"persist",t.project,s),n}function Vs(r,e){return{customTitle:r,platformSource:e?w(e):void 0}}var Z=class{db;constructor(e=Qe){e instanceof be.Database?this.db=e:(e!==":memory:"&&tt(O),this.db=new be.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensurePendingMessagesAgentColumns(),this.ensureSessionsConversationHistoryColumn()}ensureSessionsConversationHistoryColumn(){this.db.query("PRAGMA table_info(sdk_sessions)").all().some(t=>t.name==="conversation_history")||this.db.run("ALTER TABLE sdk_sessions ADD COLUMN conversation_history TEXT")}saveConversationHistory(e,t){this.db.prepare("UPDATE sdk_sessions SET conversation_history = ? WHERE id = ?").run(t,e)}getConversationHistory(e){return this.db.prepare("SELECT conversation_history FROM sdk_sessions WHERE id = ?").get(e)?.conversation_history??null}ensurePendingMessagesAgentColumns(){let e=this.db.query("PRAGMA table_info(pending_messages)").all(),t=new Set(e.map(s=>s.name));t.has("agent_id")||this.db.run("ALTER TABLE pending_messages ADD COLUMN agent_id TEXT"),t.has("agent_type")||this.db.run("ALTER TABLE pending_messages ADD COLUMN agent_type TEXT")}insertPendingMessage(e){let t=this.db.prepare(`
    ...
    `).all(e)}getAllProjects(e){let t=e?w(e):void 0,s=`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[fe];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(h,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="relevance",l=c?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,u=n?`LIMIT ${n}`:"",m=e.map(()=>"?").join(","),g=[...e],f=[];if(o&&(f.push("project = ?"),g.push(o)),i)if(Array.isArray(i)){let A=i.map(()=>"?").join(",");f.push(`type IN (${A})`),g.push(...i)}else f.push("type = ?"),g.push(i);if(a){let A=Array.isArray(a)?a:[a],y=A.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");g.push(...A),f.push(`(${y.join(" OR ")})`)}if(d){let A=Array.isArray(d)?d:[d],y=A.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");A.forEach(De=>{g.push(`%${De}%`,`%${De}%`)}),f.push(`(${y.join(" OR ")})`)}let b=f.length>0?`WHERE id IN (${m}) AND ${f.join(" AND ")}`:`WHERE id IN (${m})`,S=this.db.prepare(`
      SELECT *
      FROM observations
      ${b}
      ${l}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=Vs(n,o),c=d.platformSource??h,l=L(z(s),{project:t,surface:"sqlite"}),u=d.customTitle?L(d.customTitle,{project:t,surface:"sqlite"}):d.customTitle,m=this.db.prepare(`
    ...
    `).get(e);if(m){if(t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,l,u||null,i.toISOString(),a),this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e).id}saveUserPrompt(e,t,s){let n=new Date,o=n.getTime(),i=L(z(s),{surface:"sqlite"});return this.db.prepare(`
    ...
    `).run(e,t,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),l=G(s,["title","subtitle","narrative","facts","concepts","metadata"],{project:t,surface:"sqlite"}),u=Se(e,l.title,l.narrative),g=this.db.prepare(`
    ...
    `).run(e,t,c.request,c.investigated,c.learned,c.completed,c.next_steps,c.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let c=a??Date.now(),l=new Date(c).toISOString();return this.db.transaction(()=>{let m=[],g=this.db.prepare(`
        ...
        ON CONFLICT(memory_session_id, content_hash) DO NOTHING
        RETURNING id
      `),f=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let S=G(p,["title","subtitle","narrative","facts","concepts"],{project:t,surface:"sqlite"}),R=Se(e,S.title,S.narrative),A=g.get(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,S.agent_type??null,S.agent_id??null,R,l,c,d||null);if(A){m.push(A.id);continue}let y=f.get(e,R);if(!y)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${R}`);m.push(y.id)}let b=null;if(n){let p=G(n,["request","investigated","learned","completed","next_steps","notes"],{project:t,surface:"sqlite"}),R=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  ...
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ot(r,e,t){return r.db.prepare(`
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,t.sessionCount+Oe)}function ht(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function es(r,e,t,s){let n=[];return s?n.push(...jt(r)):n.push(...yt(r)),s?n.push(...Xt()):n.push(...vt()),s&&(n.push(...Bt()),n.push(...Wt())),k(t)&&(s?n.push(...oe(e,t)):n.push(...re(e,t))),n}var Ce=D(require("path"),1);function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Ie(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ne(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function ss(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ts(r,e){return Ce.default.isAbsolute(r)?Ce.default.relative(e,r):r}function rs(r,e,t){let s=ae(r);if(s.length>0)return ts(s[0],e);if(t){let n=ae(t);if(n.length>0)return ts(n[0],e)}return"General"}function sr(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=ss(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function ns(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?ae(r.facts).join(`
`):null}function rr(r,e,t,s){let n=[];n.push(...Ut(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Ie(a.displayTime);n.push(...kt(a,d))}else{let a=i.data,d=Ne(a.created_at),l=d!==o?d:"";if(o=d,t.has(a.id)){let m=ns(a,s);n.push(...wt(a,l,m,s))}else n.push(Pt(a,l,s))}return n}function nr(r,e,t,s,n){let o=[];o.push(...Kt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,l=Ie(c.displayTime);o.push(...Jt(c,l))}else{let c=d.data,l=rs(c.files_modified,n,c.files_read),u=Ne(c.created_at),m=u!==a;a=u;let g=t.has(c.id);if(l!==i&&(o.push(...Yt(l)),i=l),g){let f=ns(c,s);o.push(...qt(c,u,m,f,s))}else o.push(Vt(c,u,m,s))}return o.push(""),o}function or(r,e,t,s,n,o){return o?nr(r,e,t,s,n):rr(r,e,t,s)}function os(r,e,t,s,n){let o=[],i=sr(r);for(let[a,d]of i)o.push(...or(a,d,e,t,s,n));return o}function is(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function as(r,e){let t=[];return e?(t.push(...K("Investigated",r.investigated,E.blue)),t.push(...K("Learned",r.learned,E.yellow)),t.push(...K("Completed",r.completed,E.green)),t.push(...K("Next Steps",r.next_steps,E.magenta))):(t.push(...W("Investigated",r.investigated)),t.push(...W("Learned",r.learned)),t.push(...W("Completed",r.completed)),t.push(...W("Next Steps",r.next_steps))),t}function ds(r,e){return e?zt(r):Ft(r)}function _s(r,e,t){return!k(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Zt(r.totalDiscoveryTokens,r.totalReadTokens):$t(r.totalDiscoveryTokens,r.totalReadTokens)}var ir=ls.default.join((0,cs.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function ar(){try{return new Z}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Es.unlinkSync)(ir)}catch(e){e instanceof Error?_.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):_.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return _.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function dr(r,e){return e?Qt(r):Ht(r)}function _r(r,e,t,s,n,o,i,a=!1){let d=[],c=he(e);if(a)return k(s)?(i?oe(c,s):re(c,s)).join(`
`).trimEnd():"";d.push(...es(r,c,s,i));let l=t.slice(0,s.sessionCount),u=Nt(l,t),m=Lt(e,u),g=Dt(e,s.fullObservationCount);d.push(...os(m,g,s,n,i));let f=t[0],b=e[0];is(s,f,b)&&d.push(...as(f,i));let p=It(e,s,o,n);return d.push(...ds(p,i)),d.push(..._s(c,s,i)),d.join(`
`).trimEnd()}var lr=new Set(["bugfix","discovery","decision","refactor"]);function cr(r,e,t){let s=he(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=lr.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Le(r,e=!1){let t=ft(),s=r?.cwd??process.cwd(),n=Tt(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=ar();if(!a)return{text:"",stats:null};try{let d=o.length>1?ht(a,o,t):bt(a,i,t),c=o.length>1?Ct(a,o,t):Ot(a,i,t);return d.length===0&&c.length===0?{text:dr(i,e),stats:null}:{text:_r(i,d,c,t,s,r?.session_id,e,r?.economicsOnly),stats:cr(d,c,!!r?.full)}}finally{a.close()}}async function us(r,e=!1){return(await Le(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
