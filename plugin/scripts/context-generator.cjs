"use strict";var Pt=Object.create;var H=Object.defineProperty;var Ft=Object.getOwnPropertyDescriptor;var $t=Object.getOwnPropertyNames;var Ht=Object.getPrototypeOf,Gt=Object.prototype.hasOwnProperty;var Xt=(r,e)=>{for(var t in e)H(r,t,{get:e[t],enumerable:!0})},Se=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of $t(e))!Gt.call(r,n)&&n!==t&&H(r,n,{get:()=>e[n],enumerable:!(s=Ft(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?Pt(Ht(r)):{},Se(e||!r||!r.__esModule?H(t,"default",{value:r,enumerable:!0}):t,r)),jt=r=>Se(H({},"__esModule",{value:!0}),r);var hs={};Xt(hs,{generateContext:()=>kt,generateContextWithStats:()=>Te});module.exports=jt(hs);var Ut=y(require("path"),1),xt=require("os"),wt=require("fs");var _e=require("bun:sqlite");var p=require("path"),ne=require("os"),L=require("fs");var Re=require("url");var N=require("fs"),be=require("path");var Bt=null;function Wt(r){return(Bt??process.stderr.write.bind(process.stderr))(r)}function ee(r){Wt(r)}var se=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(se||{}),te=null,re=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=U.logsDir();(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,be.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=U.settings();if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=se[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let g="";if(n){let{sessionId:l,memorySessionId:O,correlationId:S,...E}=n;Object.keys(E).length>0&&(g=` {${Object.entries(E).map(([R,f])=>`${R}=${f}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${c}${s}${g}${m}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,T+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",g={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},u=new re;var ts={};function Yt(){return typeof __dirname<"u"?__dirname:(0,p.dirname)((0,Re.fileURLToPath)(ts.url))}var Vt=Yt();function Kt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,p.join)((0,ne.homedir)(),".claude-mem"),e=(0,p.join)(r,"settings.json");try{if((0,L.existsSync)(e)){let t=JSON.parse((0,L.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var b=Kt(),M=process.env.CLAUDE_CONFIG_DIR||(0,p.join)((0,ne.homedir)(),".claude"),vs=(0,p.join)(M,"plugins","marketplaces","thedotmack"),qt=(0,p.join)(b,"archives"),Jt=(0,p.join)(b,"logs"),Qt=(0,p.join)(b,"trash"),zt=(0,p.join)(b,"backups"),Zt=(0,p.join)(b,"modes"),ys=(0,p.join)(b,"settings.json"),Oe=(0,p.join)(b,"claude-mem.db"),es=(0,p.join)(b,"vector-db"),he=(0,p.join)(b,"observer-sessions"),oe=(0,p.basename)(he),Us=(0,p.join)(M,"settings.json"),xs=(0,p.join)(M,"commands"),ws=(0,p.join)(M,"CLAUDE.md");function Ae(r){(0,L.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,p.join)(Vt,"..")}var U={dataDir:()=>b,workerPid:()=>(0,p.join)(b,"worker.pid"),serverBetaPid:()=>(0,p.join)(b,".server-beta.pid"),serverBetaPort:()=>(0,p.join)(b,".server-beta.port"),serverBetaRuntime:()=>(0,p.join)(b,".server-beta.runtime.json"),settings:()=>(0,p.join)(b,"settings.json"),database:()=>(0,p.join)(b,"claude-mem.db"),chroma:()=>(0,p.join)(b,"chroma"),combinedCerts:()=>(0,p.join)(b,"combined_certs.pem"),transcriptsConfig:()=>(0,p.join)(b,"transcript-watch.json"),transcriptsState:()=>(0,p.join)(b,"transcript-watch-state.json"),corpora:()=>(0,p.join)(b,"corpora"),supervisorRegistry:()=>(0,p.join)(b,"supervisor.json"),envFile:()=>(0,p.join)(b,".env"),logsDir:()=>Jt,archives:()=>qt,trash:()=>Qt,backups:()=>zt,modes:()=>Zt,vectorDb:()=>es,observerSessions:()=>he};var Ie=require("crypto");function ie(r,e,t){return(0,Ie.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function ae(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var A="claude";function ss(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function D(r){if(!r)return A;let e=ss(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ne(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Le(r,e,t,s){let n=Date.now()-s;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
  ...
  `).get(e,t,n)??void 0}var ve=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],Me=new RegExp(`<(${ve.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),ye=/<system-reminder>[\s\S]*?<\/system-reminder>/g,De=100;function rs(r){let e=Object.fromEntries(ve.map(n=>[n,0]));Me.lastIndex=0;let t=0,s=r.replace(Me,(n,o)=>(e[o]=(e[o]??0)+1,t+=1,""));return t>De&&u.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:De,contentLength:r.length}),{stripped:s.trim(),counts:e}}function Ue(r){return rs(r).stripped}var ns=["task-notification"],js=new RegExp(`^\\s*<(${ns.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Bs=256*1024;var de=4e3;function G(r){let e=r.trim(),s=Ue(r).trim()||e;return s.length<=de?s:(u.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:de}),`${s.slice(0,de-1)}\u2026`)}function os(r,e){return{customTitle:r,platformSource:e?D(e):void 0}}var X=class{db;constructor(e=Oe){e instanceof _e.Database?this.db=e:(e!==":memory:"&&Ae(b),this.db=new _e.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.db.run("PRAGMA journal_size_limit = 4194304")),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn()}dropWorkerPidColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(32),s=this.db.query("PRAGMA table_info(pending_messages)").all().some(n=>n.name==="worker_pid");if(!(e&&!s)){if(s)try{this.db.run("DROP INDEX IF EXISTS idx_pending_messages_worker_pid"),this.db.run("ALTER TABLE pending_messages DROP COLUMN worker_pid"),u.debug("DB","Dropped worker_pid column and its index from pending_messages")}catch(n){u.warn("DB","Failed to drop worker_pid column from pending_messages",{},n instanceof Error?n:new Error(String(n)));return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(32,new Date().toISOString())}}dropDeadPendingMessagesColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(31),t=this.db.query("PRAGMA table_info(pending_messages)").all(),s=new Set(t.map(i=>i.name)),o=["retry_count","failed_at_epoch","completed_at_epoch"].filter(i=>s.has(i));if(!(e&&o.length===0)){if(o.length>0){this.db.run("BEGIN TRANSACTION");try{this.db.run("DELETE FROM pending_messages WHERE status NOT IN ('pending', 'processing')");for(let i of o)this.db.run(`ALTER TABLE pending_messages DROP COLUMN ${i}`),u.debug("DB",`Dropped dead column ${i} from pending_messages`);e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString()),this.db.run("COMMIT")}catch(i){this.db.run("ROLLBACK"),u.warn("DB","Failed to drop dead columns from pending_messages",{},i instanceof Error?i:new Error(String(i)));return}return}e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(31,new Date().toISOString())}}initializeSchema(){this.db.run(`
    ...
    `).all(oe),t=[],s=new Set,n={};for(let i of e){let a=D(i.platform_source);n[a]||(n[a]=[]),n[a].includes(i.project)||n[a].push(i.project),s.has(i.project)||(s.add(i.project),t.push(i.project))}let o=Ne(Object.keys(n));return{projects:t,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,n[i]||[]]))}}getLatestUserPrompt(e){return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(e)}findRecentDuplicateUserPrompt(e,t,s){return Le(this.db,e,G(t),s)}getRecentSessionsWithStatus(e,t=3){return this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="relevance",m=c?"":`ORDER BY created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,g=n?`LIMIT ${n}`:"",T=e.map(()=>"?").join(","),l=[...e],O=[];if(o&&(O.push("project = ?"),l.push(o)),i)if(Array.isArray(i)){let f=i.map(()=>"?").join(",");O.push(`type IN (${f})`),l.push(...i)}else O.push("type = ?"),l.push(i);if(a){let f=Array.isArray(a)?a:[a],Z=f.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");l.push(...f),O.push(`(${Z.join(" OR ")})`)}if(d){let f=Array.isArray(d)?d:[d],Z=f.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");f.forEach(fe=>{l.push(`%${fe}%`,`%${fe}%`)}),O.push(`(${Z.join(" OR ")})`)}let S=O.length>0?`WHERE id IN (${T}) AND ${O.join(" AND ")}`:`WHERE id IN (${T})`,h=this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
      ${m}
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=os(n,o),c=d.platformSource??A,m=G(s),g=this.db.prepare(`
    ...
    `).get(e);if(g){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let l=g.platform_source?.trim()?D(g.platform_source):void 0;if(!l)this.db.prepare(`
            UPDATE sdk_sessions SET platform_source = ?
            WHERE content_session_id = ?
              AND COALESCE(platform_source, '') = ''
          `).run(d.platformSource,e);else if(l!==d.platformSource)throw new Error(`Platform source conflict for session ${e}: existing=${l}, received=${d.platformSource}`)}return g.id}return this.db.prepare(`
    ...
    `).run(e,t,i,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),c=new Date(d).toISOString(),m=ie(e,s.title,s.narrative),T=this.db.prepare(`
    ...
    `).all(...m);if(!i)return l;let O=new Map(l.map(S=>[S.id,S]));return e.map(S=>O.get(S)).filter(S=>!!S)}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="relevance",a=i?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,d=n?`LIMIT ${n}`:"",c=e.map(()=>"?").join(","),m=[...e],g=o?"AND s.project = ?":"";o&&m.push(o);let l=this.db.prepare(`
      ...
      ${a}
      ${d}
    `).all(...m);if(!i)return l;let O=new Map(l.map(S=>[S.id,S]));return e.map(S=>O.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,t=10,s=10,n){return this.getTimelineAroundObservation(null,e,t,s,n)}getTimelineAroundObservation(e,t,s=10,n=10,o){let i=o?"AND project = ?":"",a=o?[o]:[],d,c;if(e!==null){let E=`
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,e,...s,...o,t.totalObservationCount)}function Ye(r,e,t){return r.db.prepare(`
    SELECT
      ss.id,
...
`}function ht(r,e,t,s){let n=[];return s?n.push(...ct(r)):n.push(...et(r)),s?n.push(...mt()):n.push(...tt()),s&&(n.push(...Et()),n.push(...lt())),v(t)&&(s?n.push(...J(e,t)):n.push(...K(e,t))),n}var le=y(require("path"),1);function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function pe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ge(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ct(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function At(r,e){return le.default.isAbsolute(r)?le.default.relative(e,r):r}function It(r,e,t){let s=z(r);if(s.length>0)return At(s[0],e);if(t){let n=z(t);if(n.length>0)return At(n[0],e)}return"General"}function Es(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Ct(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function Nt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?z(r.facts).join(`
`):null}function ls(r,e,t,s){let n=[];n.push(...st(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=pe(a.displayTime);n.push(...it(a,d))}else{let a=i.data,d=ge(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let T=Nt(a,s);n.push(...ot(a,m,T,s))}else n.push(nt(a,m,s))}return n}function ps(r,e,t,s,n){let o=[];o.push(...pt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let c=d.data,m=pe(c.displayTime);o.push(...St(c,m))}else{let c=d.data,m=It(c.files_modified,n,c.files_read),g=ge(c.created_at),T=g!==a;a=g;let l=t.has(c.id);if(m!==i&&(o.push(...gt(m)),i=m),l){let O=Nt(c,s);o.push(...ft(c,g,T,O,s))}else o.push(Tt(c,g,T,s))}return o.push(""),o}function gs(r,e,t,s,n,o){return o?ps(r,e,t,s,n):ls(r,e,t,s)}function Lt(r,e,t,s,n){let o=[],i=Es(r);for(let[a,d]of i)o.push(...gs(a,d,e,t,s,n));return o}function Mt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Dt(r,e){let t=[];return e?(t.push(...$("Investigated",r.investigated,_.blue)),t.push(...$("Learned",r.learned,_.yellow)),t.push(...$("Completed",r.completed,_.green)),t.push(...$("Next Steps",r.next_steps,_.magenta))):(t.push(...F("Investigated",r.investigated)),t.push(...F("Learned",r.learned)),t.push(...F("Completed",r.completed)),t.push(...F("Next Steps",r.next_steps))),t}function vt(r,e){return e?bt(r):at(r)}function yt(r,e,t){return!v(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Rt(r.totalDiscoveryTokens,r.totalReadTokens):dt(r.totalDiscoveryTokens,r.totalReadTokens)}var Ts=Ut.default.join((0,xt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function fs(){try{return new X}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,wt.unlinkSync)(Ts)}catch(e){e instanceof Error?u.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):u.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return u.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ss(r,e){return e?Ot(r):_t(r)}function bs(r,e,t,s,n,o,i,a=!1){let d=[],c=Ee(e);if(a)return v(s)?(i?J(c,s):K(c,s)).join(`
`).trimEnd():"";d.push(...ht(r,c,s,i));let m=t.slice(0,s.sessionCount),g=Je(m,t),T=Qe(e,g),l=ze(e,s.fullObservationCount);d.push(...Lt(T,l,s,n,i));let O=t[0],S=e[0];Mt(s,O,S)&&d.push(...Dt(O,i));let E=qe(e,s,o,n);return d.push(...vt(E,i)),d.push(...yt(c,s,i)),d.join(`
`).trimEnd()}var Rs=new Set(["bugfix","discovery","decision","refactor"]);function Os(r,e,t){let s=Ee(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let c=Rs.has(d.type)?d.type:"other";n[c]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function Te(r,e=!1){let t=Ge(),s=r?.cwd??process.cwd(),n=$e(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=fs();if(!a)return{text:"",stats:null};try{let d=o.length>1?Ve(a,o,t):We(a,i,t),c=o.length>1?Ke(a,o,t):Ye(a,i,t);return d.length===0&&c.length===0?{text:Ss(i,e),stats:null}:{text:bs(i,d,c,t,s,r?.session_id,e,r?.economicsOnly),stats:Os(d,c,!!r?.full)}}finally{a.close()}}async function kt(r,e=!1){return(await Te(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
