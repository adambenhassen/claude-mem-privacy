...
import { CustomProvider, isCustomSelected, isCustomAvailable } from '../../CustomProvider.js';
...
export class SessionRoutes extends BaseRouteHandler {
  constructor(
    ...
    private customAgent: CustomProvider,
  ...
  private getActiveAgent(): ClaudeProvider | GeminiProvider | OpenRouterProvider | CustomProvider {
    if (isCustomSelected()) {
