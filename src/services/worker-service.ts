...
import { CustomProvider, isCustomSelected, isCustomAvailable } from './worker/CustomProvider.js';
...
export class WorkerService implements WorkerRef {
  ...
  constructor() {
    ...
    this.customAgent = new CustomProvider(this.dbManager, this.sessionManager);
